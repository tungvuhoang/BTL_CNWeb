...
//#region node_modules/sockjs-client/dist/sockjs.js
var require_sockjs = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(f) {
		...
		return (function() {
			...
			1: [function(require, module$1, exports$1) {
				(function(global) {
					(function() {
						...
						module$1.exports = require("./main")(transportList);
			...
			3: [function(require, module$3, exports$3) {
				...
				module$3.exports.EventEmitter = EventEmitter;
			}, {
				"./eventtarget": 5,
				"inherits": 57
			}],
			...
			6: [function(require, module$6, exports$6) {
				...
				module$6.exports = TransportMessageEvent;
			}, {
				"./event": 4,
				"inherits": 57
			}],
			7: [function(require, module$7, exports$7) {
				...
				module$7.exports = FacadeJS;
			}, { "./utils/iframe": 47 }],
			8: [function(require, module$8, exports$8) {
				(function(process) {
					(function() {
						"use strict";
						var urlUtils = require("./utils/url"), eventUtils = require("./utils/event"), FacadeJS = require("./facade"), InfoIframeReceiver = require("./info-iframe-receiver"), iframeUtils = require("./utils/iframe"), loc = require("./location");
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:iframe-bootstrap");
						module$8.exports = function(SockJS, availableTransports) {
							var transportMap = {};
			...
			9: [function(require, module$9, exports$9) {
				(function(process) {
					(function() {
						"use strict";
						var EventEmitter = require("events").EventEmitter, inherits = require("inherits"), objectUtils = require("./utils/object");
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:info-ajax");
			...
			10: [function(require, module$10, exports$10) {
				"use strict";
				var inherits = require("inherits"), EventEmitter = require("events").EventEmitter, XHRLocalObject = require("./transport/sender/xhr-local"), InfoAjax = require("./info-ajax");
				...
				module$10.exports = InfoReceiverIframe;
			}, {
				"./info-ajax": 9,
			...
			11: [function(require, module$11, exports$11) {
				(function(process, global) {
					(function() {
						"use strict";
						var EventEmitter = require("events").EventEmitter, inherits = require("inherits"), utils = require("./utils/event"), IframeTransport = require("./transport/iframe"), InfoReceiverIframe = require("./info-iframe-receiver");
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:info-iframe");
			...
			12: [function(require, module$12, exports$12) {
				(function(process) {
					(function() {
						...
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:info-receiver");
						...
						module$12.exports = InfoReceiver;
					}).call(this);
				}).call(this, { env: {} });
			}, {
				"./info-ajax": 9,
			...
			13: [function(require, module$13, exports$13) {
				(function(global) {
					(function() {
						"use strict";
						module$13.exports = global.location || {
			...
			14: [function(require, module$14, exports$14) {
				(function(process, global) {
					(function() {
						...
						module$14.exports = function(availableTransports) {
			...
			17: [function(require, module$17, exports$17) {
				(function(process, global) {
					(function() {
						...
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:browser:xhr");
						...
						module$17.exports = AbstractXHRObject;
					}).call(this);
				}).call(this, { env: {} }, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
			}, {
				"../../utils/event": 46,
			...
			18: [function(require, module$18, exports$18) {
				(function(global) {
					(function() {
						module$18.exports = global.EventSource;
					}).call(this);
				}).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
			}, {}],
			19: [function(require, module$19, exports$19) {
				(function(global) {
					(function() {
						...
						if (Driver) module$19.exports = function WebSocketBrowserDriver(url) {
							return new Driver(url);
						};
						else module$19.exports = void 0;
					}).call(this);
				}).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
			}, {}],
			20: [function(require, module$20, exports$20) {
				...
				module$20.exports = EventSourceTransport;
			}, {
				"./lib/ajax-based": 24,
			...
			21: [function(require, module$21, exports$21) {
				...
				module$21.exports = HtmlFileTransport;
			}, {
				"./lib/ajax-based": 24,
			...
			22: [function(require, module$22, exports$22) {
				(function(process) {
					(function() {
						"use strict";
						var inherits = require("inherits"), EventEmitter = require("events").EventEmitter, version = require("../version"), urlUtils = require("../utils/url"), iframeUtils = require("../utils/iframe"), eventUtils = require("../utils/event"), random = require("../utils/random");
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:transport:iframe");
						...
						module$22.exports = IframeTransport;
					}).call(this);
				}).call(this, { env: {} });
			}, {
				"../utils/event": 46,
			...
			23: [function(require, module$23, exports$23) {
				(function(global) {
					(function() {
						...
						module$23.exports = JsonPTransport;
					}).call(this);
				}).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
			}, {
			...
			24: [function(require, module$24, exports$24) {
				(function(process) {
					(function() {
						...
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:ajax-based");
						...
						module$24.exports = AjaxBasedTransport;
					}).call(this);
				}).call(this, { env: {} });
			}, {
				"../../utils/url": 52,
			...
			25: [function(require, module$25, exports$25) {
				(function(process) {
					(function() {
						...
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:buffered-sender");
						...
						module$25.exports = BufferedSender;
					}).call(this);
				}).call(this, { env: {} });
			}, {
				"debug": 55,
			...
			26: [function(require, module$26, exports$26) {
				(function(global) {
					(function() {
						...
						module$26.exports = function(transport) {
			...
			27: [function(require, module$27, exports$27) {
				(function(process) {
					(function() {
						...
						var inherits = require("inherits"), EventEmitter = require("events").EventEmitter;
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:polling");
			...
			28: [function(require, module$28, exports$28) {
				(function(process) {
					(function() {
						...
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:sender-receiver");
						...
						module$28.exports = SenderReceiver;
					}).call(this);
				}).call(this, { env: {} });
			}, {
				"../../utils/url": 52,
			...
			29: [function(require, module$29, exports$29) {
				(function(process) {
					(function() {
						...
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:receiver:eventsource");
						...
						module$29.exports = EventSourceReceiver;
					}).call(this);
				}).call(this, { env: {} });
			}, {
				"debug": 55,
			...
			30: [function(require, module$30, exports$30) {
				(function(process, global) {
					(function() {
						...
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:receiver:htmlfile");
						...
						module$30.exports = HtmlfileReceiver;
					}).call(this);
				}).call(this, { env: {} }, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
			}, {
				"../../utils/iframe": 47,
			...
			31: [function(require, module$31, exports$31) {
				(function(process, global) {
					(function() {
						...
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:receiver:jsonp");
						...
						module$31.exports = JsonpReceiver;
					}).call(this);
				}).call(this, { env: {} }, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
			}, {
				"../../utils/browser": 44,
			...
			32: [function(require, module$32, exports$32) {
				(function(process) {
					(function() {
						...
						var inherits = require("inherits"), EventEmitter = require("events").EventEmitter;
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:receiver:xhr");
			...
			33: [function(require, module$33, exports$33) {
				(function(process, global) {
					(function() {
						...
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:sender:jsonp");
						var form, area;
						...
						module$33.exports = function(url, payload, callback) {
							debug(url, payload);
							if (!form) createForm();
			...
			34: [function(require, module$34, exports$34) {
				(function(process, global) {
					(function() {
						...
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:sender:xdr");
			...
			35: [function(require, module$35, exports$35) {
				...
				module$35.exports = XHRCorsObject;
			}, {
				"../driver/xhr": 17,
				"inherits": 57
			}],
			...
			37: [function(require, module$37, exports$37) {
				...
				module$37.exports = XHRLocalObject;
			}, {
				"../driver/xhr": 17,
				"inherits": 57
			}],
			38: [function(require, module$38, exports$38) {
				(function(process) {
					(function() {
						...
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:websocket");
						...
						module$38.exports = WebSocketTransport;
					}).call(this);
				}).call(this, { env: {} });
			}, {
				"../utils/event": 46,
			...
			39: [function(require, module$39, exports$39) {
				...
				module$39.exports = XdrPollingTransport;
			}, {
				"./lib/ajax-based": 24,
				"./receiver/xhr": 32,
				"./sender/xdr": 34,
			...
			40: [function(require, module$40, exports$40) {
				...
				module$40.exports = XdrStreamingTransport;
			}, {
				"./lib/ajax-based": 24,
				"./receiver/xhr": 32,
				"./sender/xdr": 34,
			...
			41: [function(require, module$41, exports$41) {
				...
				module$41.exports = XhrPollingTransport;
			}, {
				"./lib/ajax-based": 24,
				"./receiver/xhr": 32,
				"./sender/xhr-cors": 35,
			...
			42: [function(require, module$42, exports$42) {
				(function(global) {
					(function() {
						...
						module$42.exports = XhrStreamingTransport;
					}).call(this);
				}).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
			}, {
				"../utils/browser": 44,
			...
			43: [function(require, module$43, exports$43) {
				(function(global) {
					(function() {
						"use strict";
						if (global.crypto && global.crypto.getRandomValues) module$43.exports.randomBytes = function(length) {
							var bytes = new Uint8Array(length);
							global.crypto.getRandomValues(bytes);
							return bytes;
						};
						else module$43.exports.randomBytes = function(length) {
			...
			45: [function(require, module$45, exports$45) {
				...
				module$45.exports = { quote: function(string) {
				...
				(function(global) {
					(function() {
						...
						var unloadTriggered = function() {
							...
							afterUnload = true;
							module$46.exports.triggerUnloadCallbacks();
						};
						if (!isChromePackagedApp) module$46.exports.attachEvent("unload", unloadTriggered);
					}).call(this);
				}).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
			}, { "./random": 50 }],
			47: [function(require, module$47, exports$47) {
				(function(process, global) {
					(function() {
						"use strict";
						var eventUtils = require("./event"), browser = require("./browser");
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:utils:iframe");
						module$47.exports = {
							WPrefix: "_jp",
							currentWindowId: null,
							polluteGlobalNamespace: function() {
								if (!(module$47.exports.WPrefix in global)) global[module$47.exports.WPrefix] = {};
							},
							postMessage: function(type, data) {
								if (global.parent !== global) global.parent.postMessage(JSON.stringify({
									windowId: module$47.exports.currentWindowId,
									type,
									data: data || ""
								}), "*");
							...
							createHtmlfile: function(iframeUrl, errorCallback) {
								var doc = new global[["Active"].concat("Object").join("X")]("htmlfile");
								var tref, unloadRef;
								var iframe;
								var unattach = function() {
									clearTimeout(tref);
								...
								doc.close();
								doc.parentWindow[module$47.exports.WPrefix] = global[module$47.exports.WPrefix];
						...
						module$47.exports.iframeEnabled = false;
						if (global.document) module$47.exports.iframeEnabled = (typeof global.postMessage === "function" || typeof global.postMessage === "object") && !browser.isKonqueror();
					}).call(this);
				}).call(this, { env: {} }, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
			}, {
				"./browser": 44,
			...
			51: [function(require, module$51, exports$51) {
				(function(process) {
					(function() {
						"use strict";
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:utils:transport");
						module$51.exports = function(availableTransports) {
			...
			52: [function(require, module$52, exports$52) {
				(function(process) {
					(function() {
						...
						var debug = function() {};
						if (process.env.NODE_ENV !== "production") debug = require("debug")("sockjs-client:utils:url");
						module$52.exports = {
			...
			54: [function(require, module$54, exports$54) {
				...
				* @api public
				*/
				module$54.exports = function(val, options) {
					options = options || {};
					var type = typeof val;
			...
			55: [function(require, module$55, exports$55) {
				(function(process) {
					(function() {
						...
						*/
						exports$55.formatArgs = formatArgs;
						exports$55.save = save;
						exports$55.load = load;
						exports$55.useColors = useColors;
						exports$55.storage = localstorage();
						exports$55.destroy = (() => {
							let warned = false;
							return () => {
								if (!warned) {
						...
						*/
						function formatArgs(args) {
							args[0] = (this.useColors ? "%c" : "") + this.namespace + (this.useColors ? " %c" : " ") + args[0] + (this.useColors ? "%c " : " ") + "+" + module$55.exports.humanize(this.diff);
						...
						* @api public
						*/
						exports$55.log = console.debug || console.log || (() => {});
						/**
						* Save `namespaces`.
						*
						...
						*/
						function save(namespaces) {
							try {
								if (namespaces) exports$55.storage.setItem("debug", namespaces);
								else exports$55.storage.removeItem("debug");
							} catch (error) {}
						}
						/**
						* Load `namespaces`.
						...
						*/
						function load() {
							let r;
							try {
								r = exports$55.storage.getItem("debug");
							} catch (error) {}
						...
						*/
						...
						module$55.exports = require("./common")(exports$55);
						const { formatters } = module$55.exports;
						/**
			...
			56: [function(require, module$56, exports$56) {
				...
				*/
				...
				module$56.exports = setup;
			}, { "ms": 54 }],
			57: [function(require, module$57, exports$57) {
				if (typeof Object.create === "function") module$57.exports = function inherits(ctor, superCtor) {
					if (superCtor) {
				...
				else module$57.exports = function inherits(ctor, superCtor) {
					if (superCtor) {
						ctor.super_ = superCtor;
			...
			58: [function(require, module$58, exports$58) {
				...
				*/
				...
				exports$58.stringify = querystringify;
				exports$58.parse = querystring;
			}, {}],
			59: [function(require, module$59, exports$59) {
				...
				* @api private
				*/
				module$59.exports = function required(port, protocol) {
